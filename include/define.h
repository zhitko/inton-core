...
#define CONFIG_DEFUALT_INTENSIVE_FRAME 256
#define CONFIG_DEFUALT_INTENSIVE_SHIFT 16
#define CONFIG_DEFUALT_INTENSIVE_SMOOTH_FRAME 200
#define CONFIG_DEFUALT_INTENSIVE_DOUBLE_SMOOTH_FRAME 200
#define SEGMANTS_BY_INTENSITY_THRESHOLD_ABSOLUTE 0.5
#define SEGMANTS_BY_INTENSITY_THRESHOLD_RELATIVE 0.1
#define SEGMANTS_BY_INTENSITY_MIN_LENGTH 20
#define SEGMANTS_BY_INTENSITY_DOUBLE_SMOOTHED_MIN_LENGTH 20
